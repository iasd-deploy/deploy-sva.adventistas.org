        ...
        <div class="wizard-content">
            <div class="sections" tabindex="-1">
                <?php $__currentLoopData = $config->sections(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo $__env->make('wizard.section', ['section' => $section, 'initial' => ($section->id() == $config->initialSectionName())], \MediaCloud\Vendor\Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</script><?php /**PATH /Users/clecyo.freitas/Documents/Dev_DSA/deploy-comunica.spa.adventistas.org/wp-content/plugins/ilab-media-tools/views/wizard/wizard.blade.php ENDPATH**/ ?>